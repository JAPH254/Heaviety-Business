...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(self, first_name,phone_number,id_number, last_name, email, password, **extra_fields):
        if not first_name:
    ...
    def create_superuser(self, first_name, last_name, email,phone_number,id_number, password, **extra_fields):
        ...
        user = self.create_user(first_name, last_name,phone_number,id_number, email, password, **extra_fields)
        user.save()
